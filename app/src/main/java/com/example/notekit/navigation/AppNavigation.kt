...
import com.example.notekit.search_note.presentation.navigation.navigateToSearchNoteScreen
...
fun AppNavigation() {
    ...
    NavHost(
        ...
        notesScreen(
            ...
            navigateToSearchNoteScreen = {
                navController.navigateToSearchNoteScreen()
            }
        )
